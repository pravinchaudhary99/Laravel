         ...
         <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
             ...
             <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                 ...
                 <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <a href="{{ route('roles.index') }}" class="text-muted text-hover-primary">
                            Roles List </a>
                    </li>
                    <!--end::Item-->
                     <!--begin::Item-->
                            ...
                            <div class="card card-flush">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-title">
                                        <h2 class="mb-0">{{ $item['role_name'] }}</h2>
                                    </div>
                                    <!--end::Card title-->
                                </div>
                                <!--end::Card header-->
                         ...
                         <div class="modal-dialog modal-dialog-centered mw-750px">
                             ...
                             <div class="modal-content">
                                 ...
                                 <div class="modal-body scroll-y mx-5 my-7">
                                     <!--begin::Form-->
                                     <form id="kt_modal_add_role_form" method="POST" class="form" action="{{ url('/roles/update/') }}/{{ $id }}">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <!--begin::Scroll-->
                                         <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                             ...
                                             <div class="fv-row mb-10">
                                                 ...
                                                 <!--begin::Input-->
                                                 <input class="form-control form-control-solid role_name"
                                         ...
                                         <div class="text-center pt-15">
                                             ...
                                             <button type="submit" class="btn btn-primary role_data_submit"
                 ...
                 <div class="flex-lg-row-fluid ms-lg-10">
                     ...
                     <div class="card card-flush mb-6 mb-xl-9">
                         ...
                         <div class="card-header pt-5">
                             <!--begin::Card title-->
                             <div class="card-title">
                                 <h2 class="d-flex align-items-center"> Users Assigned <span class="text-gray-600 fs-6 ms-1">(@if(isset($count)){{ $count }})@else (0) @endif</span></h2>
                             </div>
                             <!--end::Card title-->
