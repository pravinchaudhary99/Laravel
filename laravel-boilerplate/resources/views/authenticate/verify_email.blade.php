				...
				<div class="d-flex flex-column flex-lg-row-fluid w-lg-30 p-0 order-1 order-1">
					...
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
						...
						<div class="w-lg-500px p-10">
							<!--begin::Form-->
							<form class="form w-100 mb-13" novalidate="novalidate"  id="kt_sing_in_two_steps_form" method="POST" action="{{ route('verify-email.create') }}">
								@csrf
								<!--begin::Icon-->
								...
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Verify your email ✉️</h1>
									<!--end::Title-->
									<!--begin::Sub-title-->
