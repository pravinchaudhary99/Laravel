						...
						<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
							...
							<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
								...
								{{-- <div data-kt-menu-trigger="click" class="menu-item here menu-accordion"> --}}
									<!--begin:Menu link-->
									<a href="{{ route('home.index') }}" class="menu-link @if(isset($home)&& $home == true) active @endif">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1 @if(isset($user)&& $user == true) show @endif">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link @if(isset($user)&& $user == true) active @endif" href="{{ route('users.index') }}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1 @if(isset($role)&& $role == true) show @endif">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link @if(isset($role)&& $role == true) active @endif" href="{{ route('roles.index') }}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
