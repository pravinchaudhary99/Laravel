                    ...
                    <div class="card-body pt-9 pb-0">
                        ...
                        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                            ...
                            <div class="me-7 mb-4">
                                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                    <img src="@if(empty(auth()->user()->profile_picture)){{ asset('/assets/media/svg/avatars/blank.svg') }}@else {{ auth()->user()->profile_picture }}@endif" alt="image" />
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 @if(isset($profile))active @endif" href="{{ route('user_auth.index') }}">Overview</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 @if(isset($logs)) active @endif" href="{{ route('user_auth.logs',auth()->user()->id) }}">Logs</a>
                            </li>
                            <!--end::Nav item-->
                        </ul>
                        <!--begin::Navs-->
