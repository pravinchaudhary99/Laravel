        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <div class="m-0">
                    ...
                    <!--end::Menu toggle-->
                    <!--begin::Menu 1-->
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_63859179ad82e">
                        <!--begin::Header-->
                        <div class="px-7 py-5">
                        ...
                        <div class="px-7 py-5">
                            ...
                            <div class="mb-10">
                                ...
                                <!--begin::Input-->
                                <div>
                                    <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_63859179ad82e" data-allow-clear="true">
                                        <option></option>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            <tr>
                                ...
                                <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 1047</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="visa">
                                <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 8848</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="mastercard">
                                <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 8783</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 2325</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="visa">
                                <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 2852</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="american_express">
                                <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 8275</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="mastercard">
                                <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 8666</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="american_express">
                                <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 8254</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="visa">
                                <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 8645</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="visa">
                                <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 8269</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="mastercard">
                                <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 8949</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="american_express">
                                <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 8401</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
